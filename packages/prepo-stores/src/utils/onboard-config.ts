...
import { getNetworkByChainId, chainIdToHexString } from 'prepo-utils'
...
export const getOnboardConfig = (chainId: ChainId, appName: string): InitOptions => {
  ...
  return {
    ...
    chains: [
      {
        id: chainIdToHexString(network.chainId),
        token: 'ETH',
