  ...
  ReentrancyGuardUpgradeable
{
  ...
  function doTask() external nonReentrant {
     ...
     */
    uint256 _tasksCompletedToday = _internToTasksCompletedToday[tx.origin];
    if (_globalDayStartTime != _internToDayStartTime[tx.origin]) {
      _internToDayStartTime[tx.origin] = _globalDayStartTime;
