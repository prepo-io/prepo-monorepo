...
export const INSUFFICIENT_RP_FROM_WALLET = 'Insufficient RP balance (Wallet)'
export const INSUFFICIENT_RP_FROM_ENTERPRISE = 'Insufficient RP balance (Enterprise)'
...
export const makeRPCostBalanceEnterprise = (value: number | string): CostBalance => ({
  amount: `${value}`,
  unit: 'RP (Enterprise)',
})

export const makeRPCostBalanceWallet = (value: number | string): CostBalance => ({
  amount: `${value}`,
  unit: 'RP (Wallet)',
})
