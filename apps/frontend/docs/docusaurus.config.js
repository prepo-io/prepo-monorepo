...
module.exports = {
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: "announcement",
        content:
          "🚧 All information is a <b>work in progress</b> and <b>subject to change</b> 🚧",
      ...
      navbar: {
        ...
        items: [
          ...
          {
            type: 'doc',
            docId: 'acquisition-royale',
            position: 'left',
            label: 'Acquisition Royale',
          },
        ],
      },
      footer: {
  ...
  scripts: [
    "https://cdn.panelbear.com/analytics.js?site=KdPR54pbOMF",
    "./scripts/panelbear.js",
  ],
}
