...
> {
  ...
  get allowedRpSpending(): number | undefined {
    ...
    if (address === undefined || this.address === undefined) return undefined
    return transformRawEther(this.root.runwayPointsContractStore.allowance(address, this.address))
  }
